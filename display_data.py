...
def build_image(disp):
  ...
  hum_widget = widget(buffer,temp_widget.height+buffer*2,int(disp_width*.7)-buffer*2,int(disp_height-temp_widget.height)-buffer*3,(121,150,168,255))
  ...
  time_widget = widget(hum_widget.width+buffer*2, temp_widget.height+buffer*2, disp_width-hum_widget.width-buffer*3, disp_height-temp_widget.height-buffer*3,color=	(210,169,147,0))
