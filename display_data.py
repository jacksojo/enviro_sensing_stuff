...
def build_image(disp):
  ...
  hum_widget.add_text(pre_unit, very_small_font, small_font.getlength(pre)+buffer*2, small_font_height-very_small_font_height+buffer, line_width=.5)
  hum_widget.add_text(hum,small_font,buffer,hum_widget.height/2+buffer, line_width=1)
  hum_widget.add_text(hum_unit, very_small_font, small_font.getlength(hum)+buffer*2, small_font_height+very_small_font_height+buffer, line_width=.5)
  hum_widget.publish()
