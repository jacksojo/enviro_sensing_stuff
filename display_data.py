...
def build_image(disp):
  ...
  temp_widget.add_line(temp_history,buffer,buffer,temp_widget.width-10,50,color=(255,255,255,255))
  temp_widget.add_text(big,large_font,temp_widget.width-big_w-small_w-buffer,temp_widget.height-large_font_height+10,line_width=2,color=(255,255,255,160))
