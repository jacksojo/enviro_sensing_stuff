...
class BME280:
        ...
        self._bme280 = Device(
            ...
            registers=(
                ...
                Register(
                    ...
                    0xF4,
                    fields=(
                        BitField("osrs_t", 0b11100000, adapter=LookupAdapter({1: 0b001, 2: 0b010, 4: 0b011, 8: 0b100, 16: 0b101})),  # Temperature oversampling
                        BitField("osrs_p", 0b00011100, adapter=LookupAdapter({1: 0b001, 2: 0b010, 4: 0b011, 8: 0b100, 16: 0b101})),  # Pressure oversampling
                        BitField("mode", 0b00000011, adapter=LookupAdapter({"sleep": 0b00, "forced": 0b10, "normal": 0b11})),  # Power mode
                    ),
                ),
                Register("CTRL_HUM", 0xF2, fields=(BitField("osrs_h", 0b00000111, adapter=LookupAdapter({1: 0b001, 2: 0b010, 4: 0b011, 8: 0b100, 16: 0b101})),)),  # Humidity oversampling
                Register(
                    "CONFIG",
                    0xF5,
                    fields=(
                        BitField(
                            ...
                            adapter=LookupAdapter({0.5: 0b000, 62.5: 0b001, 125: 0b010, 250: 0b011, 500: 0b100, 1000: 0b101, 10: 0b110, 20: 0b111}),
                        ),
                ...
                Register("DATA", 0xF7, fields=(BitField("humidity", 0x000000000000FFFF), BitField("temperature", 0x000000FFFFF00000), BitField("pressure", 0xFFFFF00000000000)), bit_width=8 * 8),
                Register(
                    "CALIBRATION",
                    0x88,
                    fields=(
    ...
    def setup(self, mode="normal", temperature_oversampling=1, pressure_oversampling=1, humidity_oversampling=1, temperature_standby=0):
        if self._is_setup:
            return
        self._is_setup = True
    ...
    def get_altitude(self, qnh=1012.00):
        self.update_sensor()
